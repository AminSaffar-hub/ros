...
from init_particles_caller import call_service
...
if __name__ == '__main__':
    try:
        ...
        rotate (90, 90 , True)
        i = i+1
        while (((current_pose.covariance[0] > 0.65) or (current_pose.covariance[7] > 0.65) or (current_pose.covariance[35] > 0.65)) ):
            rospy.loginfo("try number : %s" %i)
            move (0.3, 2 , False)
            time.sleep(1.0)
            rotate (90, 90 , True)
